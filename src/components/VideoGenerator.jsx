...
function VideoGenerator() {
  ...
  return (
    <div className="flex min-h-screen justify-start items-center flex-col p-4 mt-24 relative">
      <div className="max-w-2xl flex flex-col gap-4">
        <div className="flex flex-col gap-4 justify-center items-center md:min-w-[42rem]">
          ...
          {/* ***** Upload ***** */}
          <div className="w-full">
            <h3 className="text-2xl font-bold w-full text-start mb-2">
              Upload a video
            </h3>
            <input
              type="file"
          ...
          {showError && (
            <strong className="mt-4 text-red-600">
          ...
          <div>
            ...
            <label htmlFor="terms" className="text-gray-700">
              ...
              and confirm that you have the rights to use any uploaded content.
              Videos must comply with all applicable laws and our content
              guidelines.
            </label>
          </div>
          ...
          {status && (
            <p
              className={`mt-4 ${
                messageIsCritial ? "text-red-600" : "text-gray-700"
              }`}
            >
              {status}
            </p>
